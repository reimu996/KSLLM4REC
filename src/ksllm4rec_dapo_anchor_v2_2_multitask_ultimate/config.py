...
_LOG_DIR = (
    ...
    / "operation_logs/rloo/dapo_anchor_v2_2_multitask_sft372_e2"
)
_RUN_DIR = (
    contract.PROJECT_ROOT
    / "artifacts/rloo/runs/dapo_anchor_v2_2_multitask_sft372_e2"
)
...
_CONFIG_TEMPLATE: dict[str, Any] = {
    ...
    "data": {
        ...
        "tasks": ["recommendation", "item_text_to_sid"],
        "recommendation_groups": contract.EXPECTED_RECOMMEND_GROUPS,
        "recommendation_positives": contract.EXPECTED_POSITIVE_EDGES,
        "text_to_sid_groups": contract.EXPECTED_TEXT_TO_SID_GROUPS,
        "text_to_sid_positives": contract.EXPECTED_TEXT_TO_SID_POSITIVE_EDGES,
        "groups": contract.TOTAL_MULTITASK_GROUPS,
        "cutoff_len": 16384,
    ...
    "sampling": {
        ...
        "max_unique_prompts_per_window": contract.TOTAL_MULTITASK_GROUPS,
    ...
    "output": {
        "recommendation_groups_dir": str(contract.GROUPS_DIR),
...
def validate_config(
    ...
    expected = {
        ...
        ("data", "tasks"): ["recommendation", "item_text_to_sid"],
        ("data", "recommendation_groups"): contract.EXPECTED_RECOMMEND_GROUPS,
        ("data", "recommendation_positives"): contract.EXPECTED_POSITIVE_EDGES,
        ("data", "text_to_sid_groups"): contract.EXPECTED_TEXT_TO_SID_GROUPS,
        ("data", "text_to_sid_positives"): contract.EXPECTED_TEXT_TO_SID_POSITIVE_EDGES,
        ("data", "groups"): contract.TOTAL_MULTITASK_GROUPS,
        ...
        ("sampling", "max_unique_prompts_per_window"): contract.TOTAL_MULTITASK_GROUPS,
        ...
        ("train", "effective_epochs"): contract.EFFECTIVE_EPOCHS,
        ("train", "windows_per_effective_epoch"): contract.WINDOWS_PER_EFFECTIVE_EPOCH,
        ...
        ("train", "resume_save_windows"): 25,
        ("memory", "max_reserved_gib"): contract.MAX_RESERVED_GIB,
        ("output", "recommendation_groups_dir"): str(contract.GROUPS_DIR),
        ("output", "text_to_sid_groups_dir"): str(contract.TEXT_TO_SID_GROUPS_DIR),
        ("output", "trie_dir"): str(contract.TRIE_DIR),
    }
