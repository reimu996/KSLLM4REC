"""Frozen contract for DAPO-Anchor-Multitask V1.0."""
...
SOURCE_BLOCKS = 532
SOURCE_EPOCHS = 1
TOTAL_SOURCE_GROUPS = EXPECTED_RECOMMENDATION_GROUPS + EXPECTED_TEXT_GROUPS
...
ANCHOR_CALIBRATION_BLOCKS = 16
ANCHOR_MIN_CALIBRATION_BLOCKS = 8
