...
def run_anchor_phase(
    ...
    *,
    ...
    if not math.isclose(
        float(max_weight),
        float(config["anchor"]["max_weight"]),
        rel_tol=0.0,
        abs_tol=0.0,
    ):
        raise ValueError("Anchor max_weight differs from the frozen config.")
...
def _window_log_row(
    ...
    *,
    ...
    return {
        ...
        "anchor_max_weight": training.anchor.max_weight,
