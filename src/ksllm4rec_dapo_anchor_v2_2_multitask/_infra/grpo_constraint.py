...
from .grpo_contract import DOMAINS, EMPTY_THINK, MAX_SID_COMPONENT, RESPONSE_PREFIX
from .grpo_probability import legal_log_probs
from .grpo_trie import SidPrefixTrie
...
class RecommendationGrammar:
    ...
    def __init__(
        ...
        *,
        ...
        elif mode in {"probe_text_to_sid", "train_text_to_sid"}:
