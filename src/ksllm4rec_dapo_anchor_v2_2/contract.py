...
PROFILE = "frontier_sft372_dapo_anchor_v2_2"
...
ANCHOR_CALIBRATION_WINDOWS = 16
ANCHOR_MIN_CALIBRATION_WINDOWS = 8
...
TOTAL_RL_OPTIMIZER_UPDATES = TOTAL_WINDOWS * OPTIMIZER_UPDATES_PER_WINDOW  # 4256
