...
def main() -> int:
    parser = argparse.ArgumentParser(prog="verify-dapo-anchor-multitask-v1-probe64")
    ...
    from ksllm4rec_dapo_anchor_multitask_v1._infra.grpo_trie import SidPrefixTrie
    from ksllm4rec_dapo_anchor_multitask_v1.config import validate_config
    from ksllm4rec_dapo_anchor_multitask_v1.evaluation import load_fixed_probe
    from ksllm4rec_dapo_anchor_multitask_v1.verify import validate_probe64_report
