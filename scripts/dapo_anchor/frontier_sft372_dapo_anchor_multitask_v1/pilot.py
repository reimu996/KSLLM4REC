"""Run one isolated Multitask V1 optimization-window GPU pilot."""
...
def main() -> int:
    parser = argparse.ArgumentParser(prog="dapo-anchor-multitask-v1-pilot")
    ...
    from ksllm4rec_dapo_anchor_multitask_v1.trainer import run_one_window_pilot
