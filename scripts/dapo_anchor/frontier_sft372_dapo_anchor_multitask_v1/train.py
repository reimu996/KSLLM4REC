"""Frozen formal launcher for DAPO-Anchor-Multitask V1."""
...
def main() -> int:
    parser = argparse.ArgumentParser(prog="dapo-anchor-multitask-v1-train")
    ...
    from ksllm4rec_dapo_anchor_multitask_v1.trainer import run_training
