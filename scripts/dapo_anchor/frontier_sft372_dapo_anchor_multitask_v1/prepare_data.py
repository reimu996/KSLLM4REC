"""Build or verify the frozen Frontier text-to-SID group artifact."""
...
def _verify(output: Path) -> dict[str, object]:
    from ksllm4rec_dapo_anchor_multitask_v1 import contract
...
def main() -> int:
    parser = argparse.ArgumentParser(prog="prepare-dapo-anchor-multitask-v1-data")
