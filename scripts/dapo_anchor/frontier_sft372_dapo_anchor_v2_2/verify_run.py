"""Verify V2.2 logs, recovery counters, calibration, and runtime identity."""
...
def main() -> int:
    ...
    from ksllm4rec_dapo_anchor_v2_2._infra.dapo_fingerprint import (
        runtime_signature,
    )
    from ksllm4rec_dapo_anchor_v2_2.trainer import load_calibrated_lambda
    from ksllm4rec_dapo_anchor_v2_2.verify import (
    ...
    lambda_calibrated = load_calibrated_lambda(config, signature)
