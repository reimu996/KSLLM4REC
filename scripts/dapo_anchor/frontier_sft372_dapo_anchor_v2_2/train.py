...
ksllm4rec_dapo_anchor_v2_2._infra.dapo_fingerprint.runtime_signature -> invokes
ksllm4rec_dapo_anchor_v2_2.trainer.run_training.
...
def main() -> int:
    ...
    # Kick off training
    from ksllm4rec_dapo_anchor_v2_2.trainer import run_training
