...
PYTHONDONTWRITEBYTECODE=1 "${PYTHON}" -m compileall -q \
  src/ksllm4rec_dapo_anchor_v2_2_multitask \
...
from ksllm4rec_dapo_anchor_v2_2_multitask import contract
from ksllm4rec_dapo_anchor_v2_2_multitask.config import build_config
from ksllm4rec_dapo_anchor_v2_2_multitask.trainer import load_groups_and_trie
