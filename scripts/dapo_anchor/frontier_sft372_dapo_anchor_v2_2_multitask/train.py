...
ksllm4rec_dapo_anchor_v2_2_multitask._infra.dapo_fingerprint.runtime_signature
and invokes ksllm4rec_dapo_anchor_v2_2_multitask.trainer.run_training.
...
def main() -> int:
    ...
    # Kick off training
    from ksllm4rec_dapo_anchor_v2_2_multitask.trainer import run_training
