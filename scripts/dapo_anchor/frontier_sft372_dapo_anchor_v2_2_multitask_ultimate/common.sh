...
readonly CONFIG="${ROOT}/configs/rloo/frontier_sft372_g16_dapo_anchor_v2_2_multitask_ultimate_e2.yaml"
readonly LOG_ROOT="${ROOT}/operation_logs/rloo/dapo_anchor_v2_2_multitask_ultimate_sft372_e2"
readonly RUN_DIR="${ROOT}/artifacts/rloo/runs/dapo_anchor_v2_2_multitask_ultimate_sft372_e2"
